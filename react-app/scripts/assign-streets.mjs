...
// Resolve the spreadsheet: CLI arg wins, else look in ../Data for the known name.
const argPath = process.argv[2];
const DEFAULT_XLSX = path.resolve(
  ROOT,
  "..",
  "Data",
  "GirardOhio-Water-Accounts-2026-04-07_3.xlsx",
);
const XLSX_PATH = argPath ? path.resolve(argPath) : DEFAULT_XLSX;

if (!fs.existsSync(XLSX_PATH)) {
  console.error(`Spreadsheet not found: ${XLSX_PATH}`);
  console.error(
    "Pass the path as an argument, e.g.: npm run assign-streets -- ../Data/GirardOhio-Water-Accounts-2026-04-07_3.xlsx",
  );
  process.exit(1);
}
